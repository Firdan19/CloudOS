...
case "$TEST_SUITE" in
    ...
    shell-command-smoke)
        ...
        assert_log "$log_path" "[ci] command capxfer"
        assert_log "$log_path" "[ci] command caprevoke"
    ...
    ipc-mailbox)
        ...
        assert_log "$log_path" "[ci] ipc timeout Ring 3"
        assert_log "$log_path" "[ci] ipc timeout exit code"
        assert_log "$log_path" "[ci] ipc timeout wakeup"
        assert_log "$log_path" "[ci] ipc cancellation Ring 3"
        assert_log "$log_path" "[ci] ipc cancellation exit code"
        assert_log "$log_path" "[ci] ipc cancellation wakeup"
        assert_log "$log_path" "[ci] ipc wait restart completion"
        assert_log "$log_path" "[ci] ipc wait scheduler clean"
        assert_log "$log_path" "[ci] ipc wait endpoint clean"
        assert_log "$log_path" "[ci] ipc wait frame baseline"
        assert_log "$log_path" "[ci] ipc wait heap baseline"
        assert_log "$log_path" "[ci] ipc wait resource baseline"
        assert_log "$log_path" "[ci] ipc wait control status"
        assert_log "$log_path" "[ci] ipc transfer Ring 3"
        assert_log "$log_path" "[ci] ipc transfer received handle"
        assert_log "$log_path" "[ci] ipc transfer rights attenuated"
        assert_log "$log_path" "[ci] ipc transfer delegation denied"
        assert_log "$log_path" "[ci] ipc transfer escalation denied"
        assert_log "$log_path" "[ci] ipc transfer forged denied"
        assert_log "$log_path" "[ci] ipc transfer queue full atomic"
        assert_log "$log_path" "[ci] ipc transfer table full atomic"
        assert_log "$log_path" "[ci] ipc transfer cleanup revoked"
        assert_log "$log_path" "[ci] ipc transfer blocking switches"
        assert_log "$log_path" "[ci] ipc transfer restart completion"
        assert_log "$log_path" "[ci] ipc transfer scheduler clean"
        assert_log "$log_path" "[ci] ipc transfer frame baseline"
        assert_log "$log_path" "[ci] ipc transfer heap baseline"
        assert_log "$log_path" "[ci] ipc transfer resource baseline"
        assert_log "$log_path" "[ci] ipc transfer status"
        assert_log "$log_path" "[ci] ipc revoke lineage chain"
        assert_log "$log_path" "[ci] ipc revoke Ring 3 syscall"
        assert_log "$log_path" "[ci] ipc revoke cascade"
        assert_log "$log_path" "[ci] ipc revoke queued attachment stripped"
        assert_log "$log_path" "[ci] ipc revoke message preserved"
        assert_log "$log_path" "[ci] ipc revoke descendants stale"
        assert_log "$log_path" "[ci] ipc revoke before send"
        assert_log "$log_path" "[ci] ipc receive before revoke"
        assert_log "$log_path" "[ci] ipc cancel after revoke denied"
        assert_log "$log_path" "[ci] ipc revoke blocked target preserved"
        assert_log "$log_path" "[ci] ipc revoke cleanup cascade"
        assert_log "$log_path" "[ci] ipc revoke scheduler clean"
        assert_log "$log_path" "[ci] ipc revoke endpoint clean"
        assert_log "$log_path" "[ci] ipc revoke frame baseline"
        assert_log "$log_path" "[ci] ipc revoke heap baseline"
        assert_log "$log_path" "[ci] ipc revoke resource baseline"
        assert_log "$log_path" "[ci] ipc revoke status"
